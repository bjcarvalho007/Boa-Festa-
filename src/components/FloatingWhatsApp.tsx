...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.9 }}
      onClick={handleClick}
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[100] bg-[#25D366] text-white p-2.5 md:p-3 rounded-full shadow-2xl flex items-center justify-center hover:bg-[#128C7E] transition-colors group"
      id="floating-whatsapp"
    >
      <MessageCircle size={22} fill="white" className="md:w-6 md:h-6 group-hover:animate-bounce" />
