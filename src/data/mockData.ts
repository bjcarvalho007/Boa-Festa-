...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: 'Kit sem o Painel 1.50x1.50!Somente Cilindros - Capa para os Cilindros - E Boleiras! ( não trabalhamos com arco de balões! )',
    price: 60.00,
  ...
  },
  {
    ...
    description: 'Kit delicado com painel decorativo "Boy or Girl", pelúcia de urso e suportes dourados. ( não trabalhamos com arco de balões! )',
    price: 40.00,
  ...
  },
  {
    ...
    description: 'Celebre com as cores do Mengão! Painel sublimado e acessórios pretos de alta qualidade. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Para o torcedor fiel! Painel do Timão com suportes brancos e pretos elegantes. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Painel vibrante de estádio com suportes temáticos para os amantes do esporte. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Tema "É uma menina" com decoração floral, pelúcia e painel delicado. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Painel moderno com mensagem de Gratidão em fundo galáxia e arranjos azuis. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    id: '7',
    name: 'Kit Bday Gold',
    description: 'Celebração sofisticada com painel Happy Birthday, suportes dourados e bolo fake. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    id: '8',
    name: 'Kit Tardezinha',
    description: 'Clima de festa tropical com painel pôr do sol e acessórios em cores vibrantes. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Painel misto rosa e azul com vasos e suportes coordenados. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Decoração feminina moderna com painel glitter rosa e suportes combinando. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'O clássico favorito das crianças com painel alegre e suportes coloridos. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'Ação e aventura para sua festa! Kit completo do herói com painel e acessórios temáticos. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
  ...
  },
  {
    ...
    description: 'A doçura da Moranguinho na sua festa! Decoração encantadora com tons vibrantes e painel maravilhoso. ( não trabalhamos com arco de balões! )',
    price: 40.00,
    category: 'Festa na mesa',
